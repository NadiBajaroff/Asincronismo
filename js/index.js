...
function renderizarDatosUsuario(datos) {
  ...
  let datosUsuario = datosParseados.results[0];
  tarjeta.innerHTML = `
    <h2>${datosUsuario.name.first
      .charAt(0)
      .toUpperCase()}${datosUsuario.name.first.slice(
    1
  )} ${datosUsuario.name.last
    .charAt(0)
    .toUpperCase()}${datosUsuario.name.first.slice(1)}</h2>
